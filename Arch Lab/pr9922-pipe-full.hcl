#Pejmon Rahimi
#Eid: pr9922
#Changes: The only thing I did in this file is implement the IADDQ instruction
#as I had done for part B. This was done to make more efficent incrementations
#in my ncopy.ys program.
#
#/* $begin pipe-all-hcl */
####################################################################
